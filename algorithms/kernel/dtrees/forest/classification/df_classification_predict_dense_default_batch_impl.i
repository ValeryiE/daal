...
void PredictClassificationTask<algorithmFPType, cpu>::predictByTrees(size_t iFirstTree, size_t nTrees, const algorithmFPType* x,
    ...
    std::cout << std::endl;
    std::cout << "Model has been finished!" << std::endl;
}
...
Status PredictClassificationTask<algorithmFPType, cpu>::predictByAllTrees(size_t nTreesTotal,
    const DimType& dim)
{
    //std::cout << "@@Predict by all trees" << std::endl;
    ...
    //std::cout << "@@Predict by all trees AFTER BLOCKS" << std::endl;
    ...
    //std::cout << "@@Predict by all trees BEFORE THREADED FOR" << std::endl;
    //
    //std::cout << "N DATA BLOCKS " << dim.nDataBlocks << std::endl;
    ...
    {
        //std::cout << "@@Predict by all trees IBLOCK START IT" << std::endl;
        ...
        //std::cout << "N ROWS PROCESS " << nRowsToProcess << std::endl;
        //std::cout << "@@Predict by all trees BEFORE THREADED FOR" << std::endl;
        ...
        daal::threader_for(nRowsToProcess, nRowsToProcess, [&](size_t iRow)
        {
            ...
            //std::cout << "@@Predict by all trees IBLOCK END IT" << std::endl;
        });
    });
    //std::cout << "@@Predict by all trees ENDDDD" << std::endl;
